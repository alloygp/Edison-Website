...
export const REVIEW_ITEMS: ReviewItem[] = [
  ...
  { label: 'Condo Association vs HOA', path: '/blog/condo-association-vs-hoa/', review: true },
  { label: 'Florida HOA Laws Guide', path: '/blog/florida-hoa-laws-guide/', review: true },
  { label: 'Florida Milestone Inspection Guide', path: '/blog/florida-milestone-inspection-guide/', review: true },
  { label: 'HOA Audit', path: '/blog/hoa-audit/', review: true },
  { label: 'HOA Board Member Responsibilities', path: '/blog/hoa-board-member-responsibilities/', review: true },
  { label: 'HOA Bylaws vs CCRs', path: '/blog/hoa-bylaws-vs-ccrs/', review: true },
  { label: 'HOA Management Fees', path: '/blog/hoa-management-fees/', review: true },
  { label: 'HOA Reserve Study Guide Florida', path: '/blog/hoa-reserve-study-guide-florida/', review: true },
  { label: 'HOA Reserve Study Guide', path: '/blog/hoa-reserve-study-guide/', review: true },
  { label: 'HOA Special Assessment', path: '/blog/hoa-special-assessment/', review: true },
  { label: 'Unenforceable HOA Rules Florida', path: '/blog/unenforceable-hoa-rules-florida/', review: true },
