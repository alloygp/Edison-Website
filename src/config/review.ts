...
export const REVIEW_ITEMS: ReviewItem[] = [
  ...
  { label: 'Reserve Study Support', path: '/services/hoa-accounting/reserve-study-support/', review: true },
  { label: 'HOA Collections', path: '/services/hoa-collections/', review: true },
  ...
  { label: 'Milestone Inspections', path: '/services/condo-management/milestone-inspections/', review: true },
  { label: 'Structural Integrity Reserve Study', path: '/services/condo-management/structural-integrity-reserve-study/', review: true },
  ...
  { label: 'Self-Managed HOA', path: '/solutions/self-managed-hoa/', review: true },
  { label: 'Modern HOA Management', path: '/solutions/modern-hoa-management/', review: true },
  { label: 'Meet Our Team', path: '/about/meet-our-team/', review: true },
  { label: 'Meet Your Management', path: '/about/meet-your-management/', review: true },
  { label: 'Blog', path: '/blog/', review: true },
  { label: 'HOA Reserve Study Guide Florida', path: '/blog/hoa-reserve-study-guide-florida/', review: true },
  { label: 'HOA Audit', path: '/blog/hoa-audit/', review: true },
  { label: 'HOA Bylaws vs CCRs', path: '/blog/hoa-bylaws-vs-ccrs/', review: true },
  { label: 'Edison Education', path: '/edison-education/', review: true },
  { label: 'Privacy Policy', path: '/privacy-policy/', review: true },
  { label: 'Terms of Service', path: '/terms-of-service/', review: true },
];
